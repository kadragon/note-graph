...
Based on the historical spec catalog in `AGENTS.md`, the following test categories are planned:
...
6. **Warning Safety**: Investigate warnings before suppressing or ignoring them
