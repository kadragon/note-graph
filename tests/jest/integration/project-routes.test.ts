...
// Integration tests for Project API routes (Jest)
...
describe('Project API Routes', () => {
  ...
  describe('POST /api/projects', () => {
    it('should create project with all required fields', async () => {
      ...
      // Act
      const response = await authFetch(testEnv, 'http://localhost/api/projects', {
        method: 'POST',
  ...
  describe('GET /api/projects', () => {
    ...
    it('should filter projects by status', async () => {
      // Act
      const response = await authFetch(testEnv, 'http://localhost/api/projects?status=진행중');
    ...
    it('should filter projects by leader', async () => {
      ...
      const response = await authFetch(
        testEnv,
        'http://localhost/api/projects?leaderPersonId=PERSON-001'
      );
    ...
    it('should filter projects by department', async () => {
      // Act
      const response = await authFetch(testEnv, 'http://localhost/api/projects?deptName=개발팀');
  ...
  describe('GET /api/projects/:projectId', () => {
    ...
    it('should return project detail with associations', async () => {
      // Act
      const response = await authFetch(testEnv, `http://localhost/api/projects/${projectId}`);
    ...
    it('should return 404 for non-existent project', async () => {
      // Act
      const response = await authFetch(testEnv, 'http://localhost/api/projects/NONEXISTENT');
  ...
  describe('GET /api/projects/:projectId/stats', () => {
    ...
    it('should return project statistics', async () => {
      // Act
      const response = await authFetch(testEnv, `http://localhost/api/projects/${projectId}/stats`);
    ...
    it('should return 404 for non-existent project', async () => {
      // Act
      const response = await authFetch(testEnv, 'http://localhost/api/projects/NONEXISTENT/stats');
  ...
  describe('POST /api/projects/:projectId/participants', () => {
    ...
    it('should add participant to project', async () => {
      ...
      const response = await authFetch(
        testEnv,
        `http://localhost/api/projects/${projectId}/participants`,
        {
          method: 'POST',
    ...
    it('should return 404 for non-existent project', async () => {
      ...
      const response = await authFetch(
        testEnv,
        'http://localhost/api/projects/NONEXISTENT/participants',
        {
          method: 'POST',
  ...
  describe('POST /api/projects/:projectId/work-notes', () => {
    ...
    it('should assign work note to project', async () => {
      ...
      const response = await authFetch(
        testEnv,
        `http://localhost/api/projects/${projectId}/work-notes`,
        {
          method: 'POST',
