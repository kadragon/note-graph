...
// Unit tests for ChunkingService (migrated from Vitest to Jest)
  ...
  describe('chunkWorkNote()', () => {
    ...
    it('should preserve all metadata fields', () => {
      const metadata = {
        ...
        created_at_bucket: '2024-01-08',
      };

      const chunks = chunkingService.chunkWorkNote('WORK-008', 'Test', 'Content', metadata);

      expect(chunks[0].metadata.person_ids).toBe('P-001,P-002');
