export function buildWorkNoteFtsCte(): { sql: string; rankColumn: string; joinCondition: string } {
  return {
...
export function buildWorkNoteBm25Cte(): {
  sql: string;
  scoreColumn: string;
...
export function buildMeetingMinuteFtsCte(): {
  sql: string;
  rankColumn: string;
  joinCondition: string;
} {
...
export function buildMeetingMinuteFtsCteWithLimit(): {
  sql: string;
  rankColumn: string;
  joinCondition: string;
} {
...
export function buildMeetingMinuteFilterCte(): { sql: string; joinCondition: string } {
  return {
