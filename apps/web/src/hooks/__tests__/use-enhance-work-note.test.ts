    ...
    act(() => {
      result.current.actions.populateFromEnhanceResponse({
        enhancedDraft: {
          ...
          content: '향상된 내용',
          category: '업무',
          todos: [{ title: '새 할일', description: '설명', dueDate: '2024-02-01', priority: 3 }],
        },
        existingCategoryIds: [],
        existingPersonIds: [],
        originalContent: '원본 내용',
    ...
    act(() => {
      result.current.actions.populateFromEnhanceResponse({
        enhancedDraft: {
          ...
          category: '',
          todos: [
            { title: '할일 1', description: '', dueDate: '2024-02-01', priority: 3 },
            { title: '할일 2', description: '', dueDate: '2024-02-02', priority: 3 },
          ],
        },
        existingCategoryIds: [],
        existingPersonIds: [],
